...
tf.flags.DEFINE_string('X_input_dir', '/data/ljy/cycleGan-1-12/data/vis',
                       'X input directory, default: /data/ljy/cycleGan-1-12/data/vis')
tf.flags.DEFINE_string('Y_input_dir', '/data/ljy/cycleGan-1-12/train_data/ir',
                       'Y input directory, default: /data/ljy/cycleGan-1-12/data/ir')
tf.flags.DEFINE_string('X_output_file', '/data/ljy/cycleGan-1-12/tfrecords/vis.tfrecords',
                       'X output tfrecords file, default: /data/ljy/cycleGan-1-12/tfrecords/vis.tfrecords')
tf.flags.DEFINE_string('Y_output_file', '/data/ljy/cycleGan-1-12/tfrecords/ir.tfrecords',
                       'Y output tfrecords file, default:/data/ljy/cycleGan-1-12/tfrecords/ir.tfrecords')
