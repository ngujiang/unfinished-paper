...
tf.flags.DEFINE_string('X', '/data/ljy/cycleGan-1-12/tfrecords/vis.tfrecords',
                       'X tfrecords file for training, default: /data/ljy/cycleGan-1-12/tfrecords/vis.tfrecords')
tf.flags.DEFINE_string('Y', '/data/ljy/cycleGan-1-12/tfrecords/ir.tfrecords',
                       'Y tfrecords file for training, default: /data/ljy/cycleGan-1-12/tfrecords/ir.tfrecords')
